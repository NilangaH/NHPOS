                ...
                >
                  ...
                  <div class="flex-grow-1 d-bock">
                    ...
                    >
                      ...
                      <!-- <div class="w-40 w-sm-100 item-title">{{product.exp_date}}</div> -->
            ...
            <div style="max-width:400px;margin:0px auto">
              <div class="info">
                ...
                <p>
                  ...
                  <!-- <span v-show="pos_settings.show_expiry_date">{{$t('ExpiryDate')}} :{{invoice_pos.sale.exp_date}}<br></span> -->
                  <!-- <span>{{$t('ExpiryDate')}} : {{invoice_pos.sale.exp_date}} <br></span> -->
          ...
          <b-modal hide-footer size="lg" id="Add_Payment" :title="$t('AddPayment')">
            <b-form @submit.prevent="Submit_Payment">
              ...
              <b-row class="mt-4">
                  ...
                  <!-- Account -->
                  <b-col lg="6" md="6" sm="12">
                  <validation-provider name="Account":rules="{ required: true }"
                 :v-slot="validationContext">
    ...
    Invoice_POS(id) {
      ...
      axios
        ...
        .then(response => {
          ...
          this.invoice_pos.sale.exp_date = response?.data?.sale?.exp_date; // Ensure exp_date is set here
          console.log(response?.data?.sale?.exp_date,'kkk'); // Debugging line
    ...
    Check_Product_Exist(product, id) {
       ...
       if(this.load_product){
          ...
          if( product.product_type == 'is_service'){
            ...
            this.product.exp_date = product.exp_date;
