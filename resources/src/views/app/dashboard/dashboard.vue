        ...
        <div class="col-md-8">
                    <div class="card mb-30">
                        <div class="card-body p-2">
                            ...
                            <vue-good-table :columns="columns_stock" styleClass="order-table vgt-table mb-3"
                                row-style-class="text-left" :rows="stock_alerts">
                                <template slot="table-row" slot-scope="props">
                                    ...
                                    <span v-else-if="props.column.field == 'exp_date'"
                                        :class="getExpiryClass(props.row.exp_date)">
                                        {{ props.row.exp_date }}
                                    </span>
                                </template>
                            </vue-good-table>
